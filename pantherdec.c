...
int Cipher = 0;
int GCRY_CIPHER = 0;
printf("    _______                        __      __                                  ________                                       ______                    \n");
printf("   /       \\                      /  |    /  |                                /        |                                     /      \\                   \n");
printf("   $$$$$$$  | ______   _______   _$$ |_   $$ |____    ______    ______        $$$$$$$$/______   ______   _______    _______ /$$$$$$  |______    ______  \n");
printf("   $$ |__$$ |/      \\ /       \\ / $$   |  $$      \\  /      \\  /      \\          $$ | /      \\ /      \\ /       \\  /       |$$ |_ $$//      \\  /      \\ \n");
printf("   $$    $$/ $$$$$$  |$$$$$$$  |$$$$$$/   $$$$$$$  |/$$$$$$  |/$$$$$$  |         $$ |/$$$$$$  |$$$$$$  |$$$$$$$  |/$$$$$$$/ $$   |  /$$$$$$  |/$$$$$$  |\n");
printf("   $$$$$$$/  /    $$ |$$ |  $$ |  $$ | __ $$ |  $$ |$$    $$ |$$ |  $$/          $$ |$$ |  $$/ /    $$ |$$ |  $$ |$$      \\ $$$$/   $$    $$ |$$ |  $$/ \n");
printf("   $$ |     /$$$$$$$ |$$ |  $$ |  $$ |/  |$$ |  $$ |$$$$$$$$/ $$ |               $$ |$$ |     /$$$$$$$ |$$ |  $$ | $$$$$$  |$$ |    $$$$$$$$/ $$ |      \n");
...
printf(" Welcome to Panther Transfer!\n The program developed by a group of FIU students that allows for secure transfer of\n messages over SSL(Secure socket layer)! Users will be allowed to pick which encrytion and hashes will be used. \n");
printf("Current ciphers are:\n1:AES128\n2:AES256\n3:Aes192\n4:Blowfish\n5:DES\n6Twofish\n Please enter the number of the cipher you would like to use!\n>");
scanf("%d", &Cipher);
char *aesSymKey;
switch(Cipher){
  case 1: 
    GCRY_CIPHER = GCRY_CIPHER_AES128;
   aesSymKey = "one test aes key";
    break;
  case 2: 
    GCRY_CIPHER = GCRY_CIPHER_AES256;
    aesSymKey = "one test aes keyone test aes key";

    break;
  case 3: 
    GCRY_CIPHER = GCRY_CIPHER_AES192;
    aesSymKey = "one test aes keypassword";

    break;
  case 4: 
    GCRY_CIPHER = GCRY_CIPHER_BLOWFISH;
    aesSymKey = "passwordworking!";
    break;
  case 5: 
    GCRY_CIPHER = GCRY_CIPHER_DES;
    aesSymKey = "password";

    break;
  case 6: 
    GCRY_CIPHER = GCRY_CIPHER_TWOFISH;
    aesSymKey = "This is a one time panther test";
    break;
}
...
if(!strcmp(argv[2],"-d")){
    ...
    valread = read(new_socket, buffer, 1024);// takes value from the client
    close(new_socket);
    ...
    if ((new_socket
        ...
        perror("accept");
        exit(EXIT_FAILURE);}
        valread = read(new_socket, password, 128); //gets the password from the client
